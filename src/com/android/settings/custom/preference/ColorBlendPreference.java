...
import com.android.settings.custom.colorpicker.ColorPickerDialog;
import com.android.settings.custom.util.ColorUtils;
...
public class ColorBlendPreference extends Preference
    ...
    private void updateDialogSliderPreview() {
        ...
        mDialogPreviewColorBetween.setBackgroundColor(
                ColorUtils.getBlendColorForPercent(mPreviewColorEnd, mPreviewColorStart,
    ...
    private void updatePreview() {
        ...
        if (mViewColorBetween != null) {
            mViewColorBetween.setBackgroundColor(
                    ColorUtils.getBlendColorForPercent(mColorEnd, mColorStart, mBlendReverse, 50));
        }
    }
